...
const raisedToTheThird = (arr) => {
  // Solution code here...
  arr.forEach((element, index, values) => 
  {
  values[index] = Math.pow(element,3)
  });
  return arr;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let result3 = arr.map(str => str = str + '?')
  return result3;
};
...
const forEachTwoToThe = (arr) => {
  ...
  let result5 = [];
  arr.forEach((element) => {
    result5.push(Math.pow(2,element));
  });
  return result5;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
    ...
    let result6 = arr.map((element) => Math.pow(2,element));
    return result6;
};
